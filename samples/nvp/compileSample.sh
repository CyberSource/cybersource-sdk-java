...
LOCAL_CP=
# -----------------------------------------------------------------------------
# Replace this with cybersource-sdk-java-6.2.11.jar when using Java SDK 1.6 or later.
...
if test -d ../../lib
then LOCAL_CP=$LOCAL_CP:../../lib/cybersource-sdk-java-6.2.11.jar
fi
...
LOCAL_CP=$LOCAL_CP:target/dependencies/cybersource-sdk-java-6.2.11.jar
fi
