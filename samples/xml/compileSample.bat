...
set LOCAL_CP=
rem ----------------------------------------------------------------------------
rem Replace this with cybersource-sdk-java-6.2.0.jar when using Java SDK 1.6 or later.
...
if exist ../../lib set LOCAL_CP=%LOCAL_CP%;../../lib/cybersource-sdk-java-6.2.0.jar
if not exist ../../lib (
	if not exist target goto error
	set LOCAL_CP=%LOCAL_CP%;target/dependencies/cybersource-sdk-java-6.2.0.jar
)
