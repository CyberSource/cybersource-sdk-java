...
public class RunSample {
     ...
     * Entry point.
     *
     * @param args it takes the kind of transaction that has to
    ...
    /**
     * @param message Accepts the document object
     * @return returns a String representing the RequestID
     */
    ...
    /**
     * @param message Accepts the document object
     * @return returns a String representing the Decision
     */
     ...
     *
     * @param props           the Properties object to be used to derive the effective
     *                        namespace URI.
     * @param commandLineArgs the command-line arguments. The input xml file has the same
